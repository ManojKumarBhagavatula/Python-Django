...
SECRET_KEY = 'django-insecure-m3s_0kazgs1^=(e4mzg1s#non0r8k%=2yb+_pgfm5sxc#9rhpc'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR/'flashcard_app'/'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = 'static/'
STATIC_ROOT = BASE_DIR/'flashcard_app'/'static'
